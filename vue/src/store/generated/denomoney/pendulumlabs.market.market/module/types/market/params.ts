...
export interface Params {
  ...
  /** burn coin */
  burn_coin: string;
  /** denomoney_fee (parameter / 10000), 9999 representing as 99.99% */
...
export const Params = {
  encode(message: Params, writer: Writer = Writer.create()): Writer {
    ...
    if (message.denomoney_fee !== "") {
      writer.uint32(34).string(message.denomoney_fee);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.denomoney_fee = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): Params {
    ...
    if (object.denomoney_fee !== undefined && object.denomoney_fee !== null) {
      message.denomoney_fee = String(object.denomoney_fee);
    } else {
      message.denomoney_fee = "";
    }
    return message;
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.denomoney_fee !== undefined && (obj.denomoney_fee = message.denomoney_fee);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    if (object.denomoney_fee !== undefined && object.denomoney_fee !== null) {
      message.denomoney_fee = object.denomoney_fee;
    } else {
      message.denomoney_fee = "";
    }
    return message;
