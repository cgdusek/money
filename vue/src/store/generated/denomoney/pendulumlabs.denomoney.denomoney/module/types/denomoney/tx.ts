...
export const MsgdenomoneyOrderResponse = {
  ...
  decode(
    ...
    length?: number
  ): MsgdenomoneyOrderResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgdenomoneyOrderResponse,
    } as MsgdenomoneyOrderResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgdenomoneyOrderResponse {
    const message = {
      ...baseMsgdenomoneyOrderResponse,
    } as MsgdenomoneyOrderResponse;
    if (object.amountBid !== undefined && object.amountBid !== null) {
  ...
  toJSON(message: MsgdenomoneyOrderResponse): unknown {
    const obj: any = {};
    message.amountBid !== undefined && (obj.amountBid = message.amountBid);
    message.amountAsk !== undefined && (obj.amountAsk = message.amountAsk);
    message.slippage !== undefined && (obj.slippage = message.slippage);
  ...
  fromPartial(
    object: DeepPartial<MsgdenomoneyOrderResponse>
  ): MsgdenomoneyOrderResponse {
    const message = {
      ...baseMsgdenomoneyOrderResponse,
    } as MsgdenomoneyOrderResponse;
...
export interface Msg {
  ...
  denomoneyOrder(
    request: MsgdenomoneyOrder
  ): Promise<MsgdenomoneyOrderResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreatePool(request: MsgCreatePool): Promise<MsgCreatePoolResponse> {
    ...
    const promise = this.rpc.request(
      "pendulumlabs.denomoney.denomoney.Msg",
      "CreatePool",
      data
    );
