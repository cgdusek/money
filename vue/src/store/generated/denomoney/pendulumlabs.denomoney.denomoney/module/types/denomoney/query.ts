...
import { Pool, Volume } from "../denomoney/pool";
import {
  PageRequest,
  PageResponse,
...
import { Order, Orders, OrderResponse } from "../denomoney/order";
...
/** denomoney Quote: denom is the denom that is input for quote */
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "pendulumlabs.denomoney.denomoney.Query",
      "Params",
      data
    );
